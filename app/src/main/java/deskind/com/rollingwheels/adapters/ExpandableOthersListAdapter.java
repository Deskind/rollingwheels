...
public class ExpandableOthersListAdapter extends BaseExpandableListAdapter {
    private Context context;
    private List<OtherService> headers;
    private Map<Integer, List<String>> content;
    private OthersListFragment filtersListFragment;

    public ExpandableOthersListAdapter(Context context, List<OtherService> headers, Map<Integer, List<String>> content, OthersListFragment filtersListFragment) {
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        tvManufacturer.setText(headers.get(i).getOtherBrand());
        ...
        delBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                OtherService service = (OtherService) delBtn.getTag();
                DBUtility.getAppDatabase(context).getCarsDao().deleteOtherService(service.getServiceId());
